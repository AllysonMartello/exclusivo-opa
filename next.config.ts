...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/links-internos", destination: "/interno", permanent: true },
      { source: "/acessos", destination: "/interno", permanent: true },
      { source: "/central", destination: "/interno", permanent: true },
    ];
  },
};
