...
export default function LeadFormModal({ isOpen, onClose }: LeadFormModalProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const payload = {
      site: "sao-jose-dos-campos",
      origin: "Landing Page Apartamento Rua da Alegria — SJC (/sao-jose-dos-campos)",
    ...
    setIsSubmitting(false);
    onClose();
    router.push("/sao-jose-dos-campos/obrigado");
  };
                ...
                {!isSubmitted ? (
                  ...
                  >
                    ...
                    {currentStepType === "final" ? (
                      <form
                        id="lead-form-sao-jose-dos-campos"
                        name="lead-form-sao-jose-dos-campos"
                        onSubmit={handleSubmit}
                        className="lead-form space-y-6"
                        data-form-name="lead-sao-jose-dos-campos"
                      >
