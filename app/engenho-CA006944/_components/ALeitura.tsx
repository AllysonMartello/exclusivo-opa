    ...
    <section id="experiencia" className="py-32 bg-[#F8F9FA] text-primary-1">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-3xl md:text-5xl font-serif mb-16 text-primary-1 tracking-tight text-center"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-16">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-col">
            <div className="aspect-[4/3] rounded-3xl overflow-hidden mb-6 shadow-sm relative">
            ...
            <h3 className="text-2xl font-serif mb-3 text-primary-1">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="flex flex-col">
            <div className="aspect-[4/3] rounded-3xl overflow-hidden mb-6 shadow-sm relative bg-gray-100">
